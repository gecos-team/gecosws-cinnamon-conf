...
MyApplet.prototype = {
    ...
    if (launchers.length!=0){
        ...
        button.actor.connect('clicked', Lang.bind(this, function() {            
            this.menu.close();
            let [res,out]= GLib.spawn_command_line_sync('gecosws-chef-snitch-client --get-active');
            let text_info = _("GECOS Agent are running please try later.\nSee icon into systray to know when GECOS Agent finished");
            if (out == 'false\n'){
